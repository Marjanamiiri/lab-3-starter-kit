...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($_POST['email'])) {
        ...
        // Check if the email ends with "@bcit.ca"
        if (!strpos($_POST['email'], '@bcit.ca')) {
            $_SESSION['email_error'] = 'Only BCIT email addresses are allowed.';
            $errors = true;
        }
    }
    ...
    if ($errors) {
        ...
        // Set the "authenticated" flag in session data
